...
from(bucket: "MicroclimateTraffic-team08-Final")
  |> range(start: time(v: "2025-02-01T06:45:00Z"), stop: time(v: "2025-02-01T23:00:00Z"))
  |> filter(fn: (r) => r["_measurement"] == "TrafficAPIData_dasyllio")
...
from(bucket: "MicroclimateTraffic-team08-Final")
  |> range(start: time(v: "2025-02-03T06:45:00Z"), stop: time(v: "2025-02-03T23:00:00Z"))
  |> filter(fn: (r) => r["_measurement"] == "WeatherAPIData_dasyllio")
...
plt.title("Traffic Comparison in Dasyllio (Sunny vs Rainy Day)", fontsize=18)
plt.legend()
plt.grid(axis='y')
plt.savefig(f"code/frontend/correlation_diagrams/rainy_vs_sunny_diagram_dasyllio_{correlation:.2f}.png", bbox_inches='tight')
plt.show()
