...
topics = {
    ...
    "sensor3": "json/Environmental/dutch-sensor-systems-ranos-db-2:1",
    "sensor4": "json/Room monitoring/mclimate-co2-sensor:1"
}
...
def process_func():
    ...
    if sensor_data["sensor4"]:
        unified_data.update({
            "co2_level": {"value": sensor_data["sensor4"].get('co2_level'), "type": "Number"},
            })
...
def on_message(client, userdata, message):
    ...
    try:
        ...
        if sensor_topic == topics["sensor1"]:
            ...
            sensor2_meas = data.get('object', {})
            sensor_data["sensor2"] = {
                "wind_direction": sensor2_meas.get('6_Dir_ave10'),
                "wind_speed": sensor2_meas.get('3_Wind_ave10'),
                "timestamp": timestamp
            }
            print("Sensor 2 data updated:", sensor_data["sensor2"])
        elif sensor_topic == topics["sensor3"]:
            ...
            if sensor3_meas_rxinfo and isinstance(sensor3_meas_rxinfo[0], dict):
                ...
                sensor_data["sensor3"].update({
                    "latitude": location.get('latitude', None),
                    "longitude": location.get('longitude', None)
                })
            print("Sensor 3 data updated:", sensor_data["sensor3"])
        elif sensor_topic == topics["sensor4"]:
            sensor4_meas = data.get('object', {})
            sensor_data["sensor4"] = {
                "co2_level": sensor4_meas.get("CO2"),
                "timestamp": timestamp
            }
            print("Sensor 4 data updated:", sensor_data["sensor4"])
