...
const weatherIconsDay = {
    'clear sky': 'static/weather icons/clear sky day.png',
    'few clouds': 'static/weather icons/few clouds day.png',
    'scattered clouds': 'static/weather icons/scattered clouds day.png',
    'broken clouds': 'static/weather icons/broken clouds.png',
    'overcast clouds': 'static/weather icons/broken clouds.png',
    'shower rain': 'static/weather icons/shower rain.png',
    'light rain': 'static/weather icons/shower rain.png',
    'moderate rain': 'static/weather icons/shower rain.png',
    'heavy intensity rain': 'static/weather icons/shower rain.png',
    'very heavy rain': 'static/weather icons/shower rain.png',
    'extreme rain': 'static/weather icons/shower rain.png',
    'rain': 'static/weather icons/rain.png',
    'drizzle': 'static/weather icons/rain.png',
    'drizzle rain': 'static/weather icons/rain.png',
    'thunderstorm': 'static/weather icons/thunderstorm.png',
    'thunderstorm with light rain': 'static/weather icons/thunderstorm.png',
    'thunderstorm with rain': 'static/weather icons/thunderstorm.png',
    'thunderstorm with heavy rain': 'static/weather icons/thunderstorm.png',
    'thunderstorm with drizzle': 'static/weather icons/thunderstorm.png',
    'light thunderstorm': 'static/weather icons/thunderstorm.png',
    'heavy thunderstorm': 'static/weather icons/thunderstorm.png',
    'snow': 'static/weather icons/snow.png',
    'light snow': 'static/weather icons/snow.png',
    'light rain and snow': 'static/weather icons/snow.png',
    'mist': 'static/weather icons/mist.png', 
    'haze': 'static/weather icons/mist.png', 
    'fog': 'static/weather icons/mist.png', 
    'dust': 'static/weather icons/mist.png',            
};

// Weather icon mapping night
const weatherIconsNight = {
    'clear sky': 'static/weather icons/clear sky night.png',
    'few clouds': 'static/weather icons/few clouds night.png',
    'scattered clouds': 'static/weather icons/scattered clouds night.png',
    'broken clouds': 'static/weather icons/broken clouds.png',
    'overcast clouds': 'static/weather icons/broken clouds.png',
    'shower rain': 'static/weather icons/shower rain.png',
    'light rain': 'static/weather icons/shower rain.png',
...
function updateCityWeather(data) {
    ...
    weatherIcon.src = weatherIconsDay[description] || 'static/default weather.png';
...
function updateForecastData(data, location, buttonDate) {
    ...
    times.forEach(time => {
        ...
        if (weatherIcon) {
            weatherIcon.src = iconDict[description] || 'static/weather icons/default weather.png';
        }
...
function clearForecastData() {
    ...
    times.forEach(time => {
        ...
        if (weatherIcon) {
            weatherIcon.src = 'static/weather icons/default weather.png';
        }
    ...
    document.querySelectorAll('.diagramsdropdown-content button').forEach(button => {
        button.addEventListener('click', function () {
            ...
            dates.forEach(date => {
                ...
                img.src = `static/correlation_diagrams/${location}/${date}.png`;
