...
# Initialize the last processed time
last_processed_time = datetime.now(timezone.utc) - timedelta(minutes=10)
...
def on_message(client, userdata, message):
    ...
    try:
        ...
        if (current_time - last_processed_time).total_seconds() < 600:
            print("Skipping message processing: 10 minutes interval not met.")
            return
